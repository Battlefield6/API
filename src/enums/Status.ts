...
/**
* Represents the status of a `gRPC` request, is used internally, and triggers the specified exceptions.
*/
enum Status {
    /**
    ...
    */
     ...
     *
     * @exception ResourceExhaustedException
     */
